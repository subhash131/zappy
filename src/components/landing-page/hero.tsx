...
const Hero = () => {
  return (
    <div
      ...
      id="home"
    >
      <div className="bg-violet-500 px-4 py-1 rounded-full flex items-center justify-center gap-1 text-sm motion-preset-shake motion-delay-300 max-sm:text-xs">
        <PiStarFourBold size={18} />
        <p>New version 2.0 released</p>
      </div>
      <h2 className="text-gradient w-[80%] font-semibold text-6xl text-gradient motion-preset-pop max-sm:text-4xl">
        The easiest way to solve your problems
      </h2>
      <p className="text-sm text-[#9e9e9e] motion-preset-expand">
        Efficient way of solving your problem
      </p>
      <div className="flex items-center justify-center gap-4 border-[#b8b8b8] border rounded-full motion-preset-expand">
        <input
          className="bg-transparent outline-none rounded-full px-4 py-2 max-sm:w-48"
